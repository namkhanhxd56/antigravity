  ...
  return (
    <header className="flex h-14 shrink-0 items-center justify-between border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 px-6 z-40 w-full font-sans">
      <Link
        ...
        className="text-[17px] font-bold tracking-tight text-primary hover:opacity-80 transition-opacity flex items-center gap-2"
      >
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-2 border-l border-zinc-200 dark:border-zinc-800 pl-6 ml-2">
          <Link
            ...
            title="Settings"
            className="flex h-9 w-9 items-center justify-center rounded-lg bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 hover:text-primary dark:hover:text-primary transition-all hover:scale-105"
          >
            <span className="material-symbols-outlined text-[20px]">settings</span>
          </Link>
          <div className="h-8 w-8 rounded-full bg-gradient-to-br from-primary to-orange-400 border border-white/20 flex items-center justify-center text-white text-[10px] font-bold shadow-sm">
            CC
          </div>
        </div>
      </div>
